...
hook_chat_command("plot-music", "[1-6] Changes music that plays in plots (will display port author as well). Re-enter plot if you have decided to change the song while you're in it.", musicplot)
